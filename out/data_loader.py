...
class SparseDataset(Dataset):
    ...
    def __init__(self, train_data, nfeatures):
    ...
    def __getitem__(self, idx):
        ...
        kp1 = self.train_data[idx]['keypoints0']
        kp2 = self.train_data[idx]['keypoints1']

        descs1 = np.array(self.train_data[idx]['descriptors0'])
        descs2 = np.array(self.train_data[idx]['descriptors1'])
        ...
        scores1_np = np.array(self.train_data[idx]['scores0']) 
        scores2_np = np.array(self.train_data[idx]['scores1'])

        scores1_np = scores1_np[:kp1_num]
        scores2_np = scores2_np[:kp1_num]
